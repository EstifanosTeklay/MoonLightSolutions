...
1. Clone the repository to your local machine:
   ...
   ```
   git clone https://github.com/EstifanosTeklay/MoonLightSolutions.git
   ```

2. Navigate to the project directory:

   ```
   cd MoonLightSolutions
   ```
...
[Please Click Here to view the Exploratory-Data-Analysis.ipynb file](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/notebooks/Exploratory-Data-Analysis.ipynb)
...
![Dashboard](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/assets/Dashboard-1.png)

**Correlation Analysis:**
![Dashboard](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/assets/Dashboard-2.png)

**Time Series Analysis:**
![Dashboard](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/assets/Dashboard-3.png)

**Time Series Analysis:**
![Dashboard](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/assets/Dashboard-4.png)

**Box Plot Analysis:**
![Dashboard](https://github.com/EstifanosTeklay/MoonLightSolutions/blob/main/assets/Dashboard-5.png)
...
This project was completed by [Estifanos Teklay](https://github.com/EstifanosTeklay).
